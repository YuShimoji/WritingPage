...
## 1) `doc://` リンク仕様を確定し、実装と E2E を一致させる
...
## 4) インポート/エクスポートの対応範囲をプラットフォーム別に仕様化し、UI と揃える
...
## 5) プラグイン機能を正式仕様へ昇格し、実装済み機能として整理する
...
## 6) README / 関連ドキュメントの死リンクと欠落文書を整理する
...
## 7) 仕様差分の再発防止として、文書の SSOT と更新責務を決める
