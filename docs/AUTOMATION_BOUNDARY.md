...
- Reader と WYSIWYG の混同防止、`ZWPostMarkdownHtmlPipeline` の preview/reader 差分（`reader-wysiwyg-distinction.spec.js`）。WP-004 Phase 3 もこの spec をガードレールとし、差分修正は **1 件ずつ** マージする運用とする。手動で追うシナリオ一覧は [`docs/WP004_PHASE3_PARITY_AUDIT.md`](WP004_PHASE3_PARITY_AUDIT.md)
