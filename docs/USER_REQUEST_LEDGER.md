...
- **Remote sync / cross-terminal handoff**: Latest repo-context handoff is `docs/verification/2026-06-22/remote-sync-after-rich-heading-closure.md`; the Rich heading review-dedup closure checklist is `docs/verification/2026-06-22/rich-heading-feature-closure-checklist.md`, and the previous IME verification anchor is `docs/verification/2026-06-18/rich-heading-ime-spotcheck.md`. Latest editor product proof remains WP-SAVELOAD-001 / `writing-trust-workflow-001`, with verification anchor `docs/verification/2026-06-15/editor-trust-vertical-slice.md`. Previous Rich editing shortcut proof is `1e33e38 feat: add rich editing heading shortcut`; import baseline remains `a56671b test: harden import roundtrip`. On another terminal, run `git pull --ff-only origin main`, confirm clean `main...origin/main` and `HEAD...origin/main = 0 0`, then read `docs/CURRENT_STATE.md` -> `docs/INVARIANTS.md` -> `docs/INTERACTION_NOTES.md`; read `docs/USER_REQUEST_LEDGER.md` / `docs/ROADMAP.md` only when choosing the next slice, and treat project docs rather than chat history as the handoff authority.
