...
| FR-003 | MD→HTML 後処理パイプライン | プレビューと Reader で同一順序の装飾・章リンク変換。WP-004 Phase 3 は差分を単発で潰し本 spec で境界監視 | `docs/INTERACTION_NOTES.md`（WP-004） | `js/zw-postmarkdown-html-pipeline.js`, `js/zw-inline-html-postmarkdown.js` | `reader-wysiwyg-distinction.spec.js` | 2026-04-06 |
