...
| FR-003 | MD→HTML 後処理パイプライン | プレビューと Reader で同一順序の装飾・章リンク変換。markdown-it 前段は `ZWMdItBody` で共有。監査台帳 `docs/WP004_PHASE3_PARITY_AUDIT.md` | `docs/INTERACTION_NOTES.md`（WP-004）、`docs/specs/spec-textbox-render-targets.md` | `js/zw-markdown-it-body.js`, `js/zw-postmarkdown-html-pipeline.js`, `js/zw-inline-html-postmarkdown.js` | `reader-wysiwyg-distinction.spec.js` | 2026-04-06 |
