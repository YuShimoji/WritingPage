...
- Wiki の未実装項目（AI機能/画像添付）の詳細および追跡は `docs/DEVELOPMENT_STATUS.md` を参照してください。
...
4. **Embed / SDK 連携の拡張**
   - Embed時のロードアウト反映や HUD の軽量化は `docs/KNOWN_ISSUES.md`（未対応の監査項目）で追跡。`docs/EMBED_SDK.md` を併読してください。
