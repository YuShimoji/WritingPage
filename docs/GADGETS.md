...
- [提案・未実装 / 旧メモ](#reference-future)  
  将来案や残課題を一覧化。詳細な優先度・タスクは `docs/BACKLOG.md` および `docs/ROADMAP.md` で管理します。
- 関連資料  
...
> 本節は現行コードに未反映の検討事項をまとめています。詳細なタスク/スケジュールは `docs/BACKLOG.md` および `docs/ROADMAP.md` を参照してください。
