...
2. Take screenshots of:
   - Homepage
   - Any other easily accessible top-level pages
3. Save screenshots to `docs/archive/screenshots/` (create if missing).
4. Report back with the paths of the captured screenshots.
