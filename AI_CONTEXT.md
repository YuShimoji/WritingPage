...
- [done] docs/KNOWN_ISSUES.md のバージョン表記と実態の整合（P1-3） (ref: docs/tasks/TASK_003_known_issues_version_alignment.md, Status: DONE)
- [done] hello.js のテスト追加 (ref: docs/tasks/TASK_004_test_addition.md, Status: DONE)
