...
直近の状態 (2026-03-23 session 17):

- Session 17: Q3決定 + WYSIWYG演出静的プレビュー実装
  - Q3決定: 型バッジ+実スタイル (タイピング/ダイアログ/スクロールにCSS ::before バッジ)
  - スクロールブロック WYSIWYG/editor-preview 内可視化 (opacity:0→1 上書き)
  - zw-scroll-trigger→zw-scroll クラス名統一 (bridge/wysiwyg/E2E/spec)
  - ダイアログ data-* 属性追加 (EffectRenderer round-trip修正)
  - E2E: wysiwyg-dsl-preview.spec.js 7件新規, typing-effect.spec.js 2件修正
  - WRITING_PIPELINE.md Q1/Q2/Q3 解決反映, 機能差マトリクス更新
- E2E: 514 passed / 1 failed (canvas-mode既知) / 3 skipped
- Lint: ALL PASSED
- 残 partial: SP-073(90%), SP-076(75%)
- 設計課題: Q1-Q4全解決。EPUB/DOCX+投機的要件16件スコープ外 (2026-03-23)
