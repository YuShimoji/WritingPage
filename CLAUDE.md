...
直近の状態 (2026-03-26 session 26):

- Session 22-24: レガシー根絶 (-5,957行)、デッドコード/CSS/API物理削除、ドキュメント一掃
- Session 25: レガシー最終掃除 + 包括調査表作成 + SP-076 done確認
- Session 26: デッドコード根絶(-1,121行) + deprecated API削除 + Visual Audit + テスト整理
  - nodegraph API/移行コード、deprecated タブ管理5メソッド、非機能タブ管理UI 削除
  - visual-audit.spec.js修正 (baseURL)、canvas-mode zoom skip化
  - ISSUES.md archive、V-2/V-3/V-4 解消見込み
- E2E: 542 passed / 0 failed / 3 skipped (63 spec files)
- spec: done 40, partial 2 (SP-005/SP-073), removed 11, superseded 1
