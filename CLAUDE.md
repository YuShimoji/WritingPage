...
直近の状態 (2026-03-18 session 6):
  - SP-050 Story Wiki: partial/95% (Phase 2 Step 1-3完了: グラフビュー+バックリンク+AI生成)
    - 力学レイアウト, カテゴリ色分け, 凡例, ノードクリック遷移, バックリンク一覧
    - テンプレート生成(7カテゴリ別) + OpenAI APIハイブリッド + 設定UI
  - SP-072 セクションリンク: done/100%
  - SP-016 拡張テキストボックス: done/100%
  - SP-074 Web小説演出: partial/15% (TextboxDslParser ブロック型拡張)
  - SP-060 装飾プリセット: done/100%
  - SP-078 読者プレビュー: done/100% (装飾パイプライン統合済み)
  - E2E: 390件/51ファイル (wiki関連40件)
  - Lint: JS 0 errors
  - 残 partial: SP-074(15%), SP-050(95%), SP-012(70%), SP-005(70%)
