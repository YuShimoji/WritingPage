...
直近の状態 (2026-03-23 session 18):

- Session 18: スコープ整理 + 仕様書一括整合 + Q4決定 + WP-002計画策定
  - 投機的要件16件をスコープ外に除外 (EPUB/DOCX/画像管理/Canvas/Google Keep/プラグイン正式化/サイドバーP2-3/WYSIWYGアニメ/長期ビジョン7件)
  - spec-index.json: Q1/Q2/Q3反映、SP-075/056/022→removed
  - spec-web-novel-effects.md: 未決定事項6件→全件解決済み
  - Q4決定: B(検証モック)。WP-003クローズ。Q1-Q4全解決
  - WP-002ガジェット統合計画策定: 33→26個 (7件統合、3フェーズ)。計画承認済み、実装は次セッション
