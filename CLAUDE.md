...
直近の状態 (2026-03-27 session 27):

- Session 27: ミニマル執筆体験 + JSONプロジェクト保存 + Electron統合
  - JSONプロジェクト保存/読込 (zenwriter-v1形式): SP-080 done
  - フォーカスモードデフォルト化 + ツールバー非表示 + 章パネルエッジホバー
  - Electron: メニューにJSON保存/読込追加
  - E2Eテスト修正 (デフォルトfocusモード追従)
- E2E: 48 passed / 1 failed(既知Legacy) / 1 skipped (主要5スイート)
- spec: done 41, partial 2 (SP-005/SP-073), removed 11, superseded 1
