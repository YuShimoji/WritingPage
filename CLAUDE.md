...
直近の状態 (2026-03-18):
  - Lint 0 errors (未使用変数8件修正済み)
  - E2E: 312+ passed / 2 failed (canvas betaEnabled:false, blank mode ステータスバー) / 1 skipped
  - E2E修正: wiki/keybinds/sections-nav のビューポート外クリック問題をevaluateクリックに移行
  - spec-index: SP-078 status done→partial修正 (HTML出力/読書進捗が残)
  - HANDOVER.md: 2026-03-17時点に全面更新
  - 仕様同期: 全specファイル実在確認済み、pct/status整合確認済み
