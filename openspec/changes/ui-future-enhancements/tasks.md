...
- [ ] 10.1 左サイドバー展開時のメインエリア隠れを修正 (パネルレイアウト調整)
- [ ] 10.2 カラーパレットの現在の色反映機能を実装
- [ ] 10.3 エディタキー移動時のガクガク振動を修正 (スクロール挙動改善)
- [ ] 10.4 折り返し文字数指定機能を追加
- [ ] 10.5 文字数表示スタンプ機能を実装 (区切り・段落集計)
- [ ] 10.6 編集ファイル/章の表示・一覧機能を追加 (UX向上)
