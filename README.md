...
`npm run app:install` �����s����ƁA`dist/` �𐶐�����������
Windows �̃X�^�[�g���j���[�� `Zen Writer` �V���[�g�J�b�g�i`.url`�j���쐬���܂��B

�쐬��:
- `%APPDATA%\\Microsoft\\Windows\\Start Menu\\Programs\\Zen Writer.url`

`npm run app:open` �Ńr���h�ς݂� `dist/index.html` ������u���E�U�ŊJ���܂��B
`npm run app:install:open` ���g���ƁA�X�^�[�g���j���[�o�^�ƋN������x�Ɏ��s�ł��܂��B
