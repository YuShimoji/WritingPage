(function(){
  ...
  function insertChoiceBlock(){
    ...
    if (typeof ed.showNotification === 'function') ed.showNotification('選択肢ブロックを挿入しました');
  }
  ...
  function insertLabel(){
    ...
    ed.insertTextAtCursor(tpl);
    if (typeof ed.showNotification === 'function') ed.showNotification('ラベルを挿入しました');
  }
  ...
  function insertJump(){
    ...
    ed.insertTextAtCursor(tpl);
    if (typeof ed.showNotification === 'function') ed.showNotification('ジャンプを挿入しました');
  }
