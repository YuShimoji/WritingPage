...
class ThemeManager {
    constructor() {
        ...
        this.applyFontSettings(this.settings.fontFamily, this.settings.fontSize, this.settings.lineHeight, this.settings.uiFontSize, this.settings.editorFontSize);
    }
    ...
    applyCustomColors(bgColor, textColor, enable = true) {
        ...
        root.style.setProperty('--sidebar-bg', isLight ? this.adjustColor(bgColor, -10) : this.adjustColor(bgColor, 20));
        root.style.setProperty('--toolbar-bg', isLight ? this.adjustColor(bgColor, -5) : this.adjustColor(bgColor, 15));
        root.style.setProperty('--border-color', isLight ? this.adjustColor(bgColor, -15) : this.adjustColor(bgColor, 30));
